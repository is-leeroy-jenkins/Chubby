# How to distribute Chubby within your own Department/Agency/Region/Division/Branch/Section

#### Step 1: Clone the source

Create a Github clone of Chubby using [our tutorial](Compilation.md).
